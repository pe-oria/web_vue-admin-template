  ...
  methods: {
    ...
    new() {
      ...
      const params = {
        ...
        coursename: this.formInline.classes,
        begin: this.formInline.time.start,
        end: this.formInline.time.end,
      };
      this.axios
        .get("http://localhost:8080/course", { params })
    ...
    add() {
      const addData = {
        coursename: this.add_form.classname,
      ...
      this.axios
        .post("http://localhost:8080/course", addData)
        .then((response) => {
    ...
    get_change(id) {
      ...
      this.axios
        ...
        .then((response) => {
          ...
          this.change_form.classname = list.coursename;
    ...
    change() {
      const changeData = {
        id: this.cid,
        coursename: this.change_form.classname,
      ...
      this.axios
        .put("http://localhost:8080/course", changeData)
        .then((response) => {
